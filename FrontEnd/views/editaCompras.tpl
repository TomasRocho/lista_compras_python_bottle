...
<div class="conteudo">
    <form action="/listaCompras/salvar" method="post">
        ...
        <input type="text" name="dataCompra"  required value="{{listaCompras['dataCompra'] if listaCompras else ''}}" placeholder="dd/mm/aaaa" pattern="[0-9]{2}/[0-9]{2}/[0-9]{4}" title="Formato inválido. Use dd/mm/aaaa">
